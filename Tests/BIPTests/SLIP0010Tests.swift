...
struct SLIP0010Tests {
    ...
    @Test(
        "Check vectors 1; https://slips.readthedocs.io/en/latest/slip-0010",
        arguments: [
            (
                "m",
    ...
    func curve25519_1(_ vector: Vector) throws {
        let seed = "000102030405060708090a0b0c0d0e0f"

        let privateKey = try Curve25519.Signing.PrivateKey(
            Data(hexadecimalString: seed)!,
            derivationPath: vector.derivationPath
        )

        #expect(privateKey.rawRepresentation.hexadecimalString == vector.privateKey)
        #expect("00" + privateKey.publicKey.rawRepresentation.hexadecimalString == vector.publicKey)
    }

    @Test(
        "Check vectors 2; https://slips.readthedocs.io/en/latest/slip-0010",
        arguments: [
            (
                "m",
    ...
    func curve25519_2(_ vector: Vector) throws {
        let seed =
